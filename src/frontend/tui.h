...
class Tui {
 ...
 private:
  ...
  // A panel over the whole terminal, which is what RenderMain draws while the
  ...
  // A notice rather than a question: the thing cannot be done, and the only
  // button says so. Every screen that raises one draws this.
