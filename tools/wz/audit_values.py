...
DEPARTURES = {
    ...
    ('Jupiter Thunder', 'lines'): 'the current arcing off each shock is priced apart',
    ...
    ('Peacemaker', 'lines'): 'the Holy Light it bursts into is priced apart',
    ...
    ('Slash Shadow Formation', 'lines'): "the leader's own slash is priced apart",
