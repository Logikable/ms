...
TEST_F(HelpCommandTest, ListsRegisteredCommands) {
  frontend_.Register({"foo", "Does foo.", [](std::vector<std::string>) -> std::string {
    return "";
  }});
  frontend_.Register({"bar", "Does bar.", [](std::vector<std::string>) -> std::string {
    return "";
  }});
...
TEST_F(HelpCommandTest, DescriptionsAlignedAtSameColumn) {
  frontend_.Register({"a", "Short.", [](std::vector<std::string>) -> std::string {
    return "";
  }});
  frontend_.Register({"longer_name", "Also short.", [](std::vector<std::string>) -> std::string {
    return "";
  }});
  std::string out = frontend_.HelpText();
